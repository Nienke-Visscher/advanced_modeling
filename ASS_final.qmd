...
data_f$allow_migrants <- as.factor(data_f$allow_migrants)

rf_model <- randomForest(allow_migrants ~ ., data = data_f, importance = TRUE)
...
data_f_red <- data_f |> 
  dplyr::select(all_of(top_f), allow_migrants)
...
git reset --hard ce01fa1708409a7626f31728abd75182d64d72b2

526e1dcd94ec64addcd3614692fdcf0c90604704 ce01fa1708409a7626f31728abd75182d64d72b2
